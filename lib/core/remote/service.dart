...
import 'package:milorestaurant/core/api/end_points.dart';
import 'package:milorestaurant/core/error/exceptions.dart';
import 'package:milorestaurant/core/error/failures.dart';
import 'package:milorestaurant/core/models/config_model.dart';
...
//
  ...
  Future<Either<Failure, PackageModel>> getPackges() async {
    //LoginModel loginModel = await Preferences.instance.getUserModel();
    try {
      final response = await dio.get(
        EndPoints.packgesUri,

      );
      return Right(PackageModel.fromJson(response));
    } on ServerException {
      return Left(ServerFailure());
    }
  }
